...
<head>
<script>
        function openRemarksPopup(project_id) {
            ...
            <form action="update_project.php" method="POST">
                <input type="hidden" name="application_id" value="${project_id}">
                <div class="form-group">
                    <label for="remarksSelect">Project Status<span style="color: red;">*</span></label>
    ...
    <div id="wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <?php
                                ...
                                // echo $status;
                    ?>
                        <div class="card-title text-success" ><b><h3 style="font-weight:bolder"><?php echo $status?> Projects </h3></b></div>
                    </div>
                    <div class="row mt-5">
                                        ...
                                        <div class='col-xl-3 col-md-6 mb-4'>
                                            <div class='card border-left-success shadow h-100 py-2'>
                                                <div class='card-body'>
                                                    ...
                                                    <div class='col-auto'>
                                                        <img class='rounded-circle' src='" . $row['ad'] . "' alt='Image here' width='70px' height='70px'>
                                                    </div>";
                                                        if(!empty($row['mou'])){
                                                            echo "<div class='col-auto'><button class='btn btn-primary text-xs mt-2' onclick=\"window.open('/uts/" . $row['mou'] . "', '_blank')\">View MOU</button></div>";
                                                        }else{
                                                           echo "<div class='col-auto mt-2'><h3 style='color:red; font-size:20px'>MOU not submitted</h3></div>";
                                                        }
                                                        if(!empty($row['ad'])){
                                                            echo "<div class='col-auto ml-2'><button class='btn btn-primary text-xs mt-2' onclick=\"window.open('/uts/" . $row['ad'] . "', '_blank')\">View AD</button></div>";
                                                        }else{
                                                           echo "<div class='col-auto mt-2'><h3 style='color:red; font-size:20px'>AD is not submitted</h3></div>";
                                                        }
                                                        echo "
                                                        <div class='col-12'>
                                                        <button class='btn btn-success text-xs mt-2' onclick='openRemarksPopup(" . $row['project_id'] . ")'>Update Status</button>
                                                    </div>
                                                    </div>
                                                </div>
                                            </div>
